        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <!-- In the navbar section, add this to the existing list -->
<li class="nav-item">
    <a class="nav-link" href="booking_history.php
    " id="history-link">Booking History</a>
</li>
                </ul>
                <div class="d-flex">
                    <button class="btn btn-outline-light me-2" data-bs-toggle="modal" data-bs-target="#loginModal">Sign In</button>

<button class="btn btn-light" data-bs-toggle="modal" data-bs-target="#signupModal">Register</button>
                </div>
            </div>
        </div>
    </nav>
    ...
    <div class="modal-content">
      <form id="signup-form">
        ...
        <div class="modal-body">
          <input type="text" id="signup-name" class="form-control mb-2" placeholder="Full Name" required>
...
<div class="modal fade" id="loginModal" tabindex="-1">
  <div class="modal-dialog">
    ...
    <!-- Booking History Section (Initially Hidden) -->
<section class="container mb-5" id="history-section" style="display: none;">
    ...
    <div class="booking-card">
        ...
        <div class="card-body">
            <div id="history-container">
                ...
                <p class="text-center" id="no-history-message">You don't have any past bookings yet.</p>
            </div>
        </div>
    </div>
    ...
    id: 2,
    title: "Inception",
    description: "A skilled thief who enters people's dreams is offered a chance to have his past crimes forgiven, if he can implant an idea into someone's subconscious.",
    ...
    theaters: [
        {
            ...
            showtimes: ["9:00 AM", "1:00 PM", "4:30 PM", "8:00 PM"]
        },
        {
            id: 6,
            name: "Vision Multiplex",
            location: "Downtown",
            ...
            },
{
    id: 5,
    title: "3 Idiots",
    description: "Two friends embark on a journey to find their lost companion, while recalling their college days and the lessons they learned.",
    genre: "Comedy, Drama",
...
},
{
    id: 6,
    title: "PK",
    description: "An alien on Earth loses his communication device and questions social norms while searching for it.",
    ...
    theaters: [
        ...
        },
        {
            ...
            name: "Cinepolis",
            location: "City Center",
            showtimes: ["10:15 AM", "1:45 PM", "5:15 PM", "9:15 PM"]
        }
    ]
},

{
    id: 7,
    title: "Dangal",
    description: "Former wrestler Mahavir Singh Phogat trains his daughters to become India’s world-class wrestlers.",
    ...
    theaters: [
        {
            ...
            showtimes: ["9:45 AM", "1:15 PM", "5:00 PM", "8:45 PM"]
        },
        {
            id: 14,
            name: "Carnival Cinemas",
...
function loadBookingHistory() {
    ...
    if (selectedSeats.length === 0) {
        alert('Please select at least one seat to complete your reservation.');
        return;
    }
...
//                     <div class="row">
//                         <div class="col-md-3">
//                             <img src="${booking.poster}" class="img-fluid rounded" alt="${booking.movie_title}">
//                         </div>
//                         <div class="col-md-9">
//                             <h5>${booking.movie_title}</h5>
//                             <p><strong>Theater:</strong> ${booking.theater_name} (${booking.theater_location})</p>
//                             <p><strong>Showtime:</strong> ${booking.showtime}</p>
